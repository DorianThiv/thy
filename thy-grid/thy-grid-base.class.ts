...
import { ThyGridBaseViewModel } from './models/thy-grid-view2.class';
...
@Directive()
export abstract class ThyGridBase {
     ...
     */
    protected viewModels: ThyGridBaseViewModel[] = [];
    ...
    public onDragOver(event: any, element: ThyGridBaseViewModel) {
      event.preventDefault();
