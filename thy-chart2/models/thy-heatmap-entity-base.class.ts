...
@Directive()
export class ThyHeatmapEntityBase<T extends { Id: number, Name: string, EntityType: ThyObjectType }> {
    ...
    private _entity: T;
    private _nature: ThyNatureModel;
    ...
    public initialize(entity: any, nature: ThyNatureModel) {
        if (entity) {
            this._entity = entity;
            this._nature = nature;
            this.load();
