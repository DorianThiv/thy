...
import { ThyLangIdentifiers } from 'src/app/thy-shared/thy-services/thy-translate/models/thy-translate.enum';
import { ThyLoginService } from '../../../../thy-core/thy-login/thy-login.service';
import { ThyConverterService } from '../../../thy-services/thy-converter/thy-converter.service';
...
import { ThyRestGetConsumptionHistoryRequest, ThyRestGetRequest, ThyRestPutRequest } from '../../../thy-services/thy-rest/models/thy-rest-requests.class';
...
export class ThyHeatmapService {
  ...
  constructor(
    private loginService: ThyLoginService,
    private restService: ThyRest2Service,
